...
import kr.co.core.thefiven.databinding.FragmentSettingKnowPeople02Binding;
import kr.co.core.thefiven.utility.Common;
import kr.co.core.thefiven.utility.StringUtil;

public class SettingKnowPeopleFrag02 extends BasicFrag {
    private FragmentSettingKnowPeople02Binding binding;
    private AppCompatActivity act;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_setting_know_people_02, container, false);
        ...
        binding.flNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(binding.cbConfirm.isChecked()) {
                    ((SettingKnowPeopleAct2) act).replaceFragment(new SettingKnowPeopleFrag03());
                } else {
